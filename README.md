...
Mountain Pass custom map for [Horizon's Zombie Survival mode](https://github.com/Horizon-Private-Server/horizon-deadlocked-patch/tree/develop/survival).

![thumbnail](HUD/thumb.png)
...
git clone https://github.com/Dnawrkshp/survival_mpass.git survival_mpass
```
